...
amount_of_bonus = int(input('Enter the amount of bonus( its 15 procent so enter the multiplication of it): '))



if is_bonus:
    total_salary = basic_salary + basic_salary* bonus* amount_of_bonus
else:
